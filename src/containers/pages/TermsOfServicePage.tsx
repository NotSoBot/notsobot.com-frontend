      ...
      <div className={styles.container}>
        <div className={styles.header}>
          ...
          <div className={styles.headerDescription}>
            <span>Effective: December 19, 2022</span>
            <span>Last Updated: December 19, 2022</span>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.section}>
            ...
            <div className={styles.sectionDescription}>
              ...
              <ul>
                <li>Application means the software program provided by the Company downloaded by You on any electronic device, named NotSoBot</li>
                ...
                <li>Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to NotSoCompany, 254 Chapman Rd, Ste 208 #8692 Newark, Delaware 19702.</li>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 2 - Acknowledgment</h2>
            </div>
            <div className={styles.sectionDescription}>
              <span>These are the Terms and Conditions governing the use of this Service and the agreement that operates between You and the Company. These Terms and Conditions set out the rights and obligations of all users regarding the use of the Service.</span>
              <span>Your access to and use of the Service is conditioned on Your acceptance of and compliance with these Terms and Conditions. These Terms and Conditions apply to all visitors, users and others who access or use the Service.</span>
              <span>By accessing or using the Service You agree to be bound by these Terms and Conditions. If You disagree with any part of these Terms and Conditions then You may not access the Service.</span>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 3 - Links to Other Websites</h2>
            </div>
            <div className={styles.sectionDescription}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 4 - Termination</h2>
            </div>
            <div className={styles.sectionDescription}>
              <span>We may terminate or suspend Your access immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</span>
              <span>Upon termination, Your right to use the Service will cease immediately.</span>
            </div>
          </div>
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 6 - "AS IS" and "AS AVAILABLE" Disclaimer</h2>
            </div>
            <div className={styles.sectionDescription}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 8 - Disputes Resolution</h2>
            </div>
            <div className={styles.sectionDescription}>
              <span>If You have any concern or dispute about the Service, You agree to first try to resolve the dispute informally by contacting the Company.</span>  
            </div>
          </div>
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 9 - For European Union (EU) Users</h2>
            </div>
            <div className={styles.sectionDescription}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 10 - United States Legal Compliance</h2>
            </div>
            <div className={styles.sectionDescription}>
          ...
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 13 - Translation Interpretation</h2>
            </div>
            <div className={styles.sectionDescription}>
              <span>These Terms and Conditions may have been translated if We have made them available to You on our Service. You agree that the original English text shall prevail in the case of a dispute.</span>
            </div>
          </div>
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 14 - Changes to These Terms and Conditions</h2>
            </div>
            <div className={styles.sectionDescription}>
              <span>We reserve the right, at Our sole discretion, to modify or replace these Terms at any time. If a revision is material We will make reasonable efforts to provide at least 30 days' notice prior to any new terms taking effect. What constitutes a material change will be determined at Our sole discretion.</span>
              <span>By continuing to access or use Our Service after those revisions become effective, You agree to be bound by the revised terms. If You do not agree to the new terms, in whole or in part, please stop using the website and the Service.</span>
            </div>
          </div>
          <div className={styles.section}>
            <div className={styles.sectionTitle}>
              <h2>Section 15 - Contact Us</h2>
            </div>
            <div className={styles.sectionDescription}>
              <span>Questions about these Terms and Conditions should be sent to us via email at privacy@notsocompany.com</span>
            </div>
          </div>
        </div>
      </div>
